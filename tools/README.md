...
| `nbp2_fake_server.py` | servidor NBP/2 de bancada; agora também consegue injetar turnos `SAY_*` sintéticos e simular `SAY_END`, `SAY_CANCEL` ou queda de link no meio da fala | S1.7 / S4.3 |
