...
**Atenção:** sem `IDF_TOOLS_PATH` setado, o component manager (`prepare_dependencies`,
usado por dependências gerenciadas como `espressif/led_strip`) falha com
`CMake Error ... build.cmake:631 (message):` de corpo vazio — o traceback Python
real fica truncado acima. Sempre incluir essa variável na invocação.
